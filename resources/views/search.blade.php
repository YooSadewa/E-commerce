...
<body class="bg-[#F4F5F6] overflow-x-hidden">
    ...
    <div class="flex flex-wrap gap-[20px] justify-start px-[40px]">
        @foreach ($barangs as $barang)          
        <div class="w-[160px] h-[215px] rounded-[10px] border-black border-[1px] p-[10px]">
            <img src="{{ asset($barang->foto_utama) }}" alt="" class="w-[140px] h-[140px] m-auto rounded-[10px]">
            <div class="flex justify-between my-[5px]">
                <p class="text-[7px] flex items-center">{{$barang->nama_barang}}</p>
                <div class="flex bg-[#D9D9D9] rounded-[3px]">
                    <i class="fa-solid fa-star text-[8px] p-[2px] text-[#EAB700]"></i>
                    <p class="text-[7px] items-center flex mr-[2px]">4,9</p>
                </div>
            </div>
            <div class="flex justify-between my-[5px]">
                <p class="text-[7px] font-semibold text-[#E3001A]">In Stock</p>
                <p class="text-[5px] flex items-center">10Rb+ Terjual</p>
            </div>
            <div class="flex justify-between my-[5px]">
                <p class="text-[11px]">{{$barang->harga_barang}}</p>
                <a href="" class="text-[5px] px-[5px] font-semibold bg-[#D9D9D9] rounded-[11px] flex items-center">Masukkan ke Troli</a>
            </div>
        </div>
        @endforeach
    </div>    
