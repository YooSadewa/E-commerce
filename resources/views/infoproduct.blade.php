...
<body class="bg-[#D4D4D4] m-0 p-0">
    ...
    <div class="w-[380px] m-auto mt-[20px]
        ...
        <h1 class="font-bold text-[24px] md:text-[36px] lg:font-semibold lg:text-[40px]">Fantech ATOM96</h1>
        <div class="flex">
            <p class="font-bold text-[22px] text-[#E3001A] md:text-[28px] lg:font-semibold">In Stock</p>
            <p class="my-auto ml-auto md:text-[24px] md:mr-[50px] lg:text-[18px] lg:mr-[80px]">14 Tersisa</p>
        </div>
        <div class="flex">
        ...
        <h1 class="font-medium text-[32px] md:text-[46px] lg:mt-[15px] lg:text-[50px]">Rp. 490.000</h1>
    </div>
</div>

    <div class="w-full bg-[#FFF] rounded-[12px] min-h-[360px] p-[15px] border-b-[1px] border-black mt-[180px] md:mt-[260px] lg:mt-[80px] md:rounded-[24px] md:p-[25px] lg:p-[50px] lg:rounded-[36px]">
    ...
    <div class="w-full bg-[#FFF] mb-[150px] md:pb-[20px] rounded-[12px] min-h-[360px] border-t-[1px] border-black md:rounded-[24px] md:min-h-[525px] md:rounded-[36px]">
