...
<body class="bg-[#F4F5F6] overflow-x-hidden">
    ...
    <div class="flex flex-wrap justify-evenly">
        ...
        <div class="w-[160px] h-[215px] rounded-[10px] border-black border-[1px] p-[10px] my-[10px]
            ...
            <a href="{{ route('infoproductuser.show', $barang->id_barang) }}" class="font-semibold bg-[#D9D9D9] rounded-[11px] flex items-center md:hidden hidden text-center lg:flex lg:pl-[88px] lg:py-[10px] lg:rounded-[12px] lg:mt-[20px]">Info Product</a>
        </div>
        @endforeach
    </div>    
</body>
