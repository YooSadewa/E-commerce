<div class="footer w-full bg-white h-full mt-4 rounded-t-lg">
        ...
        <p class="mt-5 text-[16px]  font-light">Question?</p>
        <p class="text-[19px]  font-bold">0812345678</p>
        <p class="mt-2 text-[16px]  font-light">Follow Us</p>
        <div class="flex mt-2">
...
<p class="mt-6 text-[16px]  font-light w-full mb-4 lg:mt-[70px]">Copyright © 2023 Fantech. All Rights Reserved</p>
</div>
        </div>
