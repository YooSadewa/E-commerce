...
<body class="bg-gradient-to-b from-[#420008] to-[#000000] overflow-hidden">
    ...
    <div class="w-full h-full my-[63px] mt-[20px] flex">
        ...
        <h1 class="text-center font-bold -my-[15px] text-[#000]">Tambahkan Barang</h1>
            ...
            <div class="flex flex-col gap-[35px] md:gap-[80px] lg:gap-[90px] lg:w-1/2">
                ...
                <!-- Container for Foto Barang -->
                <div class="relative">
                    <label class="block mb-2 text-base text-[#000]">Foto Barang</label>
                    <div class="w-full h-[25px] text-[12px] rounded-[12px] border-black border-[1px] text-center flex items-center justify-center text-[#000] cursor-pointer" onclick="document.getElementById('foto_barang').click()">
                        File Chosen
                    </div>
