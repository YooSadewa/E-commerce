...
=======
                        <textarea id="deskripsi_barang" name="deskripsi_barang" cols="30" rows="10" class="peer border-b-[1px] border-black w-full h-[65px] placeholder-transparent focus:outline-none focus:border-blue-500 -mt-[15px] md:text-[24px] md:h-[120px] lg:max-h-[300px] lg:min-h-[37px] lg:h-[37px] lg:" placeholder=" "></textarea>
>>>>>>> 752038bde5ea77247cf849956de1378161b2a448
...
=======
                        <select id="kategori_barang" name="kategori" class="border-b-[1px] border-black w-full focus:outline-none focus:border-blue-500 mt-[5px] appearance-none md:text-[24px]">
>>>>>>> 752038bde5ea77247cf849956de1378161b2a448
